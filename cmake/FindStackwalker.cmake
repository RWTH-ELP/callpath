# CMake file
# Copyright (C) ZIH, Technische Universitaet Dresden, Federal Republic of Germany, 2011-2012
# Copyright (C) Lawrence Livermore National Laboratories, United States of America, 2011-2012
#
...
FIND_PATH(CALLPATH_STACKWALKER_LIB_PATH libstackwalk.so 
    ...
    PATH_SUFFIXES lib 
                  ...
                  x86_64_cnl/lib
                  x86_64-unknown-linux2.4/lib NO_DEFAULT_PATH)
...
set(CALLPATH_STACKWALKER_EXTRA_LIBRARIES "" CACHE STRING
    "Additional libraries needed for compiling with the Dyninst stackwalker, this is usually required if you have a static library for libdwarf.")


find_package_handle_standard_args(STACKWALKER DEFAULT_MSG CALLPATH_STACKWALKER_INCLUDE_PATH
    CALLPATH_STACKWALKER_LIBRARIES)
